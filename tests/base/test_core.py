...
@pytest.mark.asyncio
async def test_functionality_lifecycle(config: ConfigDict):
    ...
    class TestFunctionality(Functionality):
...
@pytest.mark.asyncio
async def test_plugin_with_routes(config: ConfigDict):
...
@pytest.mark.asyncio
async def test_plugin_with_cli(config: ConfigDict, monkeypatch):
...
@pytest.mark.asyncio
async def test_plugin_config_override(config: ConfigDict):
