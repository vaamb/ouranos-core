...
from ouranos.core import START_TIME
from ouranos.services.template import ServiceTemplate
from ouranos.services.shared_resources import db, scheduler
...
class SystemMonitor(ServiceTemplate):
    ...
    def _loop(self) -> None:
        ...
        while True:
            ...
            with self.mutex:
                ouranos.sdk.api.system.update_current_data(_cache)
            self.manager.dispatcher.emit(
                "application",
                "current_server_data",
                data=ouranos.sdk.api.system.get_current_data()
            )
    ...
    async def _log_resources_data(self) -> None:
        ...
        with db.scoped_session() as session:
            ...
            await ouranos.sdk.api.system.create_data_record(session, system_data)
    ...
    def _stop(self) -> None:
        ouranos.sdk.api.system.clear_current_data()
        self._stopEvent.set()
        self._thread.join()
        self._thread = None
